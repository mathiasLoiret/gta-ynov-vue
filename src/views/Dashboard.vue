    ...
    <b-row>
      ...
      <b-col sm="6" lg="4">
        <b-card no-body class="bg-primary">
          <b-card-body class="pb-0">
            <h4 class="mb-0">7H</h4>
            <p>Nombre d’heures de travail ce jour</p>
          </b-card-body>
      ...
      <b-col sm="6" lg="4">
        <b-card no-body class="bg-info">
          <b-card-body class="pb-0">
            ...
            <p>Nombre d’heures de travail / semaine</p>
          </b-card-body>
      ...
      <b-col sm="6" lg="4">
        <b-card no-body class="bg-warning">
          <b-card-body class="pb-0">
            <h4 class="mb-0">9.823</h4>
            <p>Nombre d'heure de travail / an</p>
          </b-card-body>
    ...
    <b-row>
      ...
      <b-col sm="6" lg="3">
        <div class="brand-card">
          <div class="brand-card-header" style="background-color:#20a8d8;font-weight:bolder">
            <i class="fa fa-handshake-o"></i>
            Contrat
            <div class="chart-wrapper">
              <social-box-chart-example chartId="box-chart-01" :data="[65, 59, 71, 67, 69, 55, 40]" />
            </div>
          </div>
          <div class="brand-card-body">
            <div>
              <div class="text-value">01/01/2017</div>
              <div class="text-uppercase text-muted small">Start</div>
            </div>
            <div>
              <div class="text-value">29/12/2018</div>
              <div class="text-uppercase text-muted small">End</div>
            </div>
          </div>
        </div>
      </b-col>
      ...
      <b-col sm="6" lg="3">
        <div class="brand-card">
          <div class="brand-card-header" style="background-color:#4dbd74;font-weight:bolder">
            <i class="fa fa-child"></i>
            Congés
            <div class="chart-wrapper">
              <social-box-chart-example chartId="box-chart-02" :data="[1, 13, 9, 17, 17, 41, 38]" />
            </div>
          </div>
          <div class="brand-card-body">
            <div>
              <div class="text-value">15,73</div>
              <div class="text-uppercase text-muted small">Acquired</div>
            </div>
            <div>
              <div class="text-value">12,5</div>
              <div class="text-uppercase text-muted small">Taken</div>
            </div>
          </div>
          </div>
      </b-col>
